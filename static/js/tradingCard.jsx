...
// REMEMBER TO ADD ID=ALL-CARDS IN CARDS.HTML IN BLOCK BODY DIV / SINCE WE ARE NOW REDIRECTING TO DICTIONARY ^deac
...
// tradingCard.jsx getting img from file-name(jpg) through doc.que.Sel(#id)
// ReactDOM.render(
...
// ReactDOM.render(
//   <TradingCard name="Polymorphism" skill="going on hikes" imgUrl="/static/img/polymorphism.jpeg" />,
//   document.querySelector('#polymorphism'),
// );

// ReactDOM.render(
//   <TradingCard name="Shortstack" skill="laying on plates" imgUrl="/static/img/shortstack-overflow.jpeg" />,
